...
CREATE TABLE USUARIOS (
    ...
    USU_OCUPADO CHAR(1) NULL DEFAULT 'N' COMMENT 'BANDERA QUE SIRVVE PARA SABER SI UN AGENTE ESTA SIN ASIGNACION',
    CONSTRAINT FK_USU_ROL FOREIGN KEY (USU_ROL_ID) REFERENCES ROLES (ROL_CODIGO),
    CONSTRAINT FK_USU_AGENCIA FOREIGN KEY (USU_AGENCIA_ID) REFERENCES AGENCIAS (AGE_CODIGO)
...
CREATE TABLE TICKETS (
    ...
    CONSTRAINT FK_TKT_AGENCIA FOREIGN KEY (TKT_AGENCIA_ID) REFERENCES AGENCIAS (AGE_CODIGO),
    CONSTRAINT FK_TKT_AREA FOREIGN KEY (TKT_AREA_ID) REFERENCES AREAS (AREA_CODIGO),
